---
title: ce-frontend-design
type: skill
source: external-original
origin_url: https://github.com/everyinc/compound-engineering-plugin/blob/main/plugins/compound-engineering/skills/ce-frontend-design/SKILL.md
