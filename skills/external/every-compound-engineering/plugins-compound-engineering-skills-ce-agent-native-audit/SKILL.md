---
title: ce-agent-native-audit
type: skill
source: external-original
origin_url: https://github.com/everyinc/compound-engineering-plugin/blob/main/plugins/compound-engineering/skills/ce-agent-native-audit/SKILL.md
